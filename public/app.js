...
function doctorCard(d) {
  return `<article class="doctor-card">
    <div class="doctor-photo"><div class="doctor-avatar"></div></div>
    <div class="doctor-info">
      <h3>${d.name}</h3>
      <p>${d.spec || d.specialization || ''}</p>
      <div class="meta"><span class="stars">★</span><span>${d.rating || '4.8'}</span><span>${d.exp || d.experience || ''} лет</span></div>
